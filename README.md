# 2025-02-21
1. 실시간 webrtc 모니터링 화면 
![webrtc](<스크린샷 2025-02-21 115010.png>)
2. 주어진 경로따라 라인트레이싱 
![라인트레이싱](<스크린샷 2025-02-17 025831-1.png>)
![라인 검출](<스크린샷 2025-02-20 122519.png>)
3. 구현 완료 
![통신이슈](<스크린샷 2025-02-21 102132.png>)

# 2025-02-18
1. 주행 테스트 중
![주행 중 로그](<스크린샷 2025-02-18 115250.png>)
2. dp 더미 플러그 사용 -> 시연 준비
3. yolov8을 활용한 깊이 감지 -> 전면 카메라로 부착하여 초음파 센서 대신 거리 측정 AI
4. 주행 코드와 yolo 코드 병합하기. 코드 테스트.
...
![돌발물체 감지](<스크린샷 2025-02-17 025514.png>)
...
![라인트레이싱 화면](image.png)
![라인중앙트레이싱](<스크린샷 2025-02-17 000144.png>)
-> 출발지에서 명령 기다리는 문제
-> 초점을 계속 다시 잡는..?
...
![초음파센서 로그](<스크린샷 2025-02-17 025837-1.png>)
